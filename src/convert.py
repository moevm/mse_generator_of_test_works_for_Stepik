...
def archive(course):
    ...
    shutil.make_archive(os.path.join(archive_path, 'stepik_works'), 'zip', os.path.join(os.curdir, 
        '{}'.format(course.get_id()), 'data'))
...
def archive(course):
    ...
    shutil.make_archive(os.path.join(archive_path, 'stepik_works'), 'zip', os.path.join(os.curdir, 
        '{}'.format(course.get_id()), 'data'))
    return os.path.join(archive_path, 'stepik_works.zip')
>>>>>>> cf901e19c26fb7d772c52ffd905c750ca19ba869
